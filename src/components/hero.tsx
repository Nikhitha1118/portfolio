      ...
      <div className="paddingX absolute inset-0 top-[80px] mx-auto flex max-w-7xl flex-row items-start gap-5 xs:top-[120px]">
        ...
        <div className="pointer-events-auto">
          ...
          <motion.p
            ...
            animate="show"
          >
            I&apos;m a <span className="from-primary to-accent bg-clip-text text-transparent bg-gradient-120">AI Software Development Engineer Intern</span>
            <br className="hidden sm:block" />
            specializing in machine learning and cloud-based <span className="xs:hidden landscape-sm:inline">.</span>
            <span className="hidden xs:inline landscape-sm:hidden">
              <br className="hidden sm:block" />
              solutions&nbsp;currently based in Cincinnati, OH.
              <br className="hidden sm:block" />
              Actively seeking new opportunities to apply
              <br className="hidden sm:block" />
              my skills in AI and software development.&nbsp;
            </span>
          </motion.p>
          <HeroSocial />
        </div>
